...
function togglePassengers(reservationGroup) {
    ...
    fetch(`/Admin/GetPassengers2?reservationGroup=${reservationGroup}`)
...
function applyFilter() {
    ...
    window.location.href = `/Admin/Reservations_Admin?filterType=${filter}&recordsPerPage=${recordsPerPage}`;
}
...
function updateRecordsPerPage() {
    ...
    window.location.href = `/Admin/Reservations_Admin?page=1&recordsPerPage=${recordsPerPage}&filterType=${filterType}`;
}
...
function goToPage(page) {
    const recordsPerPage = document.getElementById("recordsPerPage").value;
    const filterType = document.getElementById("filter").value;
    window.location.href = `/Admin/Reservations_Admin?page=${page}&recordsPerPage=${recordsPerPage}&filterType=${filterType}`;
}